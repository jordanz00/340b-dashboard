...
(function () {
  ...
  function checkURL() {
    ...
    if (!m) return;
    var raw = m[1];
    var name = NX.BootstrapQuery && typeof NX.BootstrapQuery.normalizeDemo === 'function'
      ? NX.BootstrapQuery.normalizeDemo(raw)
      : null;
    if (!name) {
      if (typeof console !== 'undefined' && console.warn) {
        console.warn('NEXUS: ignored unknown or unsafe ?demo= value');
      }
      return;
    }
    setTimeout(function () { play(name); }, 500);
  }
