...
(function() {
  ...
  function go(){ drawMap(); var c=document.getElementById("us-map"); if(c) lastW=c.offsetWidth; initCountUp(); initStateListHover(); initNavHighlight(); initPrint(); initPresentation(); initDarkMode(); initMethodology(); if(!touch) window.addEventListener("resize",function(){ clearTimeout(window._rt); window._rt=setTimeout(resize,300); }); }
