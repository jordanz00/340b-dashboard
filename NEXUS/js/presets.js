...
(function () {
  ...
  var builtIn = {
    ...
    'Festival Energy': { SPD: 6, RCT: 8, WRP: 6, PAL: 1, GAIN: 1.2, SMTH: 48, morphDur: 1.55, scene: 0, quality: 'balanced' },
    'Ambient Chill': { SPD: 2, RCT: 4, WRP: 3, PAL: 2, GAIN: 0.8, SMTH: 70, morphDur: 3.5, scene: 0, quality: 'balanced' },
    'Laser Show': { SPD: 6, RCT: 9, WRP: 7, PAL: 0, GAIN: 1.3, SMTH: 44, morphDur: 1.25, scene: 0, quality: 'ultra' },
    'Club': { SPD: 5, RCT: 7, WRP: 6, PAL: 0, GAIN: 1.15, SMTH: 50, morphDur: 1.75, scene: 0, quality: 'balanced', visualMacro: 'club', postFxKaleido: 0, postFxGlitch: 0.04, nexusPostTrails: 0.03, postBloomMul: 1.12, visualMode: 'hybrid' },
    ...
    'Psychedelic': { SPD: 4, RCT: 7, WRP: 6, PAL: 3, GAIN: 1.05, SMTH: 54, morphDur: 2.15, scene: 0, quality: 'balanced', visualMacro: 'psychedelic', postFxKaleido: 0.14, postFxGlitch: 0.05, nexusPostTrails: 0.11, postBloomMul: 1.08, visualMode: 'hybrid' }
  };
